...
https://www.npmjs.com/auth/cli/xxxx, you need to pass it and deliver to user. 
IImportant: ensure you run npm login/npm in interactive mode so npm understands you are a human, otherwise it will quately fail with EOTP. You need to connect to interactive terminal
